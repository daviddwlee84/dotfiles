...
| `installPersonalTools` | true | Personal CLI suite: dev, translate, exp and four lazy tools. Full bundles on; cloud-vm/minimal off. macOS uses the personal Homebrew tap; Linux uses verified release binaries. Existing hosts without this key retain their legacy selection until explicitly reconfigured. |
