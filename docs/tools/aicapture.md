...
- [`docs/zsh/aliases.md`](../zsh/aliases.md) — the repo's full custom-alias index (cpcmd/cpout/cpblock/aifix/aiexplain/aiblock live under "Tmux Integration" and "AI Capture")
