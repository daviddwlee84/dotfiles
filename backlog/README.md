...
| [`copilot-proxy-backend-2-5-2-stability`](copilot-proxy-backend-2-5-2-stability.md) | Implemented 2026-09; natural-usage observation pending | "Observe copilot-proxy 2.5.2 on long natural sessions" |
